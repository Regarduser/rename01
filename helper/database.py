...
DB_NAME = os.environ.get("DB_NAME","RENAMEBOTV3")
DB_URL = os.environ.get("DB_URL","mongodb+srv://Jivrajsinh:Jivrajsinh@cluster0.cllmdjd.mongodb.net/?retryWrites=true&w=majority")
